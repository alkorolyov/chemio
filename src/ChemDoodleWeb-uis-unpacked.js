	...
	_.innermousemove = function(e) {
		if (!this.sketcher.lasso.isActive()) {
			...
			if (p != paintRotate) {
				...
				this.sketcher.repaint();
				if (paintRotate) el.style.cursor = 'move';
...
ChemDoodle.uis.gui.imageDepot = (function (ext, undefined) {
	...
	// all pointers are PNGs
	d.POINTER_LASSO = 'iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAQAAAC1+jfqAAAAVklEQVQoz6WQuRHAQAgDV/Tfk0uTA258jxkcWBmzEh/8lbbKb6YVVTwNNrVEdBggegzxdUVr0FiyGKLpmNf5QNuSxuhSRrS+LzL75FQNM0fbSv0zOnwD5H4V0Q6i+NQAAAAASUVORK5CYII=';
	d.POINTER_ROTATE = '';
