...
ChemDoodle.uis.gui.imageDepot = (function (undefined) {
    ...
    // SVG icons
    {
        ...
        d.BOND_RECESSED = '<svg width="24" height="24"><defs></defs><g><path d="M 3.15 21.85 L 3.15 21.85 M 5.80 18.10 L 6.88 19.14 M 8.45 14.38 L 10.59 16.56 M 11.08 10.65 L 14.32 13.90 M 13.69 6.93 L 18.04 11.28 M 16.38 3.15 L 21.85 8.60 Z" stroke-width="2.3"></path></g></svg>';
...
window.onload = function() {
    let but1 = new ChemDoodle.uis.gui.desktop.Button('lasso-btn', ChemDoodle.uis.gui.imageDepot.LASSO, 'Lasso', function () {
        console.log('1 clicked!');
    });
    but1.toggle = true;
    let but2 = new ChemDoodle.uis.gui.desktop.Button('single-bond-btn', ChemDoodle.uis.gui.imageDepot.BOND_SINGLE, 'Single bond', function () {
