...
Chemio.lib = (function(undefined) {
    ...
    let lib = {};
    lib.glMatrixArrayType = MatrixArray;
    lib.MatrixArray = MatrixArray;
    lib.setMatrixArrayType = setMatrixArrayType;
    lib.determineMatrixArrayType = determineMatrixArrayType;
    lib.glMath = glMath;
    lib.vec2 = vec2;
    lib.vec3 = vec3;
    lib.vec4 = vec4;
